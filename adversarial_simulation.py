...
async def executar_simulador():
    ...
    simulator = AdversarialSimulator(azure_ai_project=azure_ai_project, credential=AzureCliCredential())
    ...
    with open(f"results/adversarial-{get_now_string()}.jsonl", "a") as f:
        f.write(resultData)
